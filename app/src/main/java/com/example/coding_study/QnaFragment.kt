...
class QnAFragment : Fragment(R.layout.qna_fragment) {
    ...
    override fun onCreateView(
        ...
        var onQnaClickListener: QnaAdapter.OnQnaClickListener = object : QnaAdapter.OnQnaClickListener { // 전체 게시글 클릭시
        ...
        var onPopularClickListener: QnaAdapter.OnPopularClickListener = object : QnaAdapter.OnPopularClickListener { // 인기 게시글 클릭 시
